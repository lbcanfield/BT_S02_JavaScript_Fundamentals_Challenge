...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The function nested can access internal as it is a globally scoped variable.
...
function lowerCaseNames(animalsArray) {
     const names = animalsArray.map(item =>
...
function USApop(animalsArray) {
     const data = animalsArray.reduce((sum, item) => {
...
function CuboidMaker(shapeObj) {
     this.length = shapeObj.length;
